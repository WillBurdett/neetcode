...
public class B_TwoSumII_InputArrayIsSortedTest {
  ...
  @Test
  public void twoSumIIOfficial_happyPath1(){
    int[] input = {2,7,11,15};
    int target = 9;
    int[] actual = undertest.twoSumOfficial(input, target);
    int[] expected = {1, 2};
    assertArrayEquals(expected, actual);
  }

  @Test
  public void twoSumIIOfficial_happyPath2(){
    int[] input = {2,3,4};
    int target = 6;
    int[] actual = undertest.twoSumOfficial(input, target);
    int[] expected = {1, 3};
  ...
  @Test
  public void twoSumIIOfficial_happyPath3(){
    int[] input = {-1,0};
    int target = -1;
    int[] actual = undertest.twoSumOfficial(input, target);
    int[] expected = {1,2};
